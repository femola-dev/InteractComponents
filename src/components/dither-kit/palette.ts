...
export const PALETTE: Record<DitherColor, Seed> = {
  ...
  // Light grey (#BEBEBE) for the part of a series that is present but not the
  // subject — e.g. the stretch past the scrub point. Deliberately lighter than
  // `grey`, which reads as absent rather than de-emphasised.
  mute: { fill: [190, 190, 190], line: [190, 190, 190], star: [190, 190, 190] },
}
